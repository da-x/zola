...
impl Config {
    ...
    /// Temporary, while we have the settings in 2 places
    /// TODO: remove me in 0.14
    pub fn dark_highlight_theme(&self) -> &str {
        if self.dark_highlight_theme != markup::DEFAULT_HIGHLIGHT_THEME {
            &self.dark_highlight_theme
        } else {
            &self.markdown.dark_highlight_theme
        }
    }
